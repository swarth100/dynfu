...
//
// kfusion::device::TsdfVolume::elem_type*
// kfusionl::device::TsdfVolume::zstep(elem_type *const ptr) const { return data
//+ dims.x * dims.y; }
...
// implemented"; return ushort2(); }  float kfusion::device::unpack_tsdf(ushort2
// value, int& weight) { throw "Not implemented"; return 0; }  float
// kfusion::device::unpack_tsdf(ushort2 value) { throw "Not implemented"; return
// 0; }
