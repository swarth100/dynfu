...
CostFunctor(std::shared_ptr<Frame> liveFrame, std::shared_ptr<Frame> canonicalFrame,
...
template <typename T>
bool operator()(Frame::Frame liveFrame, Frame::Frame canonicalFrame, T const* const* parameters, T* residuals) const {
