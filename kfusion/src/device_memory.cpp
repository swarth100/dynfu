...
kfusion::cuda::DeviceMemory &kfusion::cuda::DeviceMemory::
operator=(const kfusion::cuda::DeviceMemory &other_arg) {
  if (this != &other_arg) {
...
kfusion::cuda::DeviceMemory2D &kfusion::cuda::DeviceMemory2D::
operator=(const kfusion::cuda::DeviceMemory2D &other_arg) {
  if (this != &other_arg) {
    if (other_arg.refcount_)
      CV_XADD(other_arg.refcount_, 1);
    release();
