...
void kfusion::device::renderImage(const Depth& depth, const Normals& normals, const Reprojector& reproj,
...
void kfusion::device::renderImage(const Points& points, const Normals& normals, const Reprojector& reproj,
...
void kfusion::device::mergePointNormal(const DeviceArray<Point>& cloud, const DeviceArray<float8>& normals,
